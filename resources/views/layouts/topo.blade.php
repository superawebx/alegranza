        ...
        <div class="navbar-nav align-items-lg-center">
            ...
            <label class="nav-item navbar-text navbar-search-box p-0 active">
                ...
                <span class="navbar-search-input pl-2">
                  <input type="text" class="form-control navbar-text mx-2" placeholder="Localizar..." style="width:200px">
                </span>
            </label>
        </div>
            ...
            <div class="demo-navbar-user nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown">
                  <span class="d-inline-flex flex-lg-row-reverse align-items-center align-middle">
                      ...
                      @if(isset(Auth::user()->photograph))
                          <img width="120" alt class="d-block ui-w-30 rounded-circle" src="{{ asset(Auth::user()->photograph) }}">
                      @endif
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    ...
                    <a href="<?= url('usuario/editar/'.Auth::user()->id ); ?>" class="dropdown-item">
                        <i class="ion ion-ios-person text-lightest"></i> &nbsp; Meus Dados
                    </a>

                    <a href="javascript:void(0)" class="dropdown-item">
                        <i class="ion ion-ios-mail text-lightest"></i> &nbsp; Mensagens
                    </a>

                    <a href="<?= url('usuario/novo'); ?>" class="dropdown-item">
                        <i class="ion ion-md-settings text-lightest"></i> &nbsp; Novo Usuário
                    </a>
