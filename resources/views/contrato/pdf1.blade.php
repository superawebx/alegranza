...
<div class="row">
    <div class="container">
        ...
        <hr>
           ...
           <p><h8>CONTRATO DE LOCAÇÃO PARA USO DE ESPAÇO PARA EVENTO</h8></p>
           ...
           <p align="justify">
            ...
            @if (isset($registro->horatermino))
                <p align="justify"> A cerimônia terá inicio às <strong>{{ $registro->horainicio }}hrs, </strong>o terminio do do evento será às <strong> {{ $registro->horatermino }} hrs. </strong>Para {{ $registro->qtdpessoas }} pessoas. </p>
            @else
                <p align="justify"> A cerimônia terá inicio às <strong>{{ $registro->horainicio }}hrs. </strong> Para {{ $registro->qtdpessoas }} pessoas.</p>    
            @endif
                      
            <p><strong>Obs. Se houver alteração no horário da cerimônia, avisar por escrito com 30 dias de antecedência </strong>.</p>
           
            <p align="justify">
                <strong> 1.2 Serão 5 ( cinco ), horas de evento ( festa ) , contados a partir da abertura do Buffet . Será concedida tolerância de atraso de no máximo 30 (trinta) minutos. Ultrapassando o horário previsto , será cobrada uma taxa no valor de 10% , por hora adicional ou fração. </strong>.
             </p>
            <p align="justify">
            ...
            <p align="justify">
                1.4 Este contrato não abrange a utilização dos aposentos. Salvo se, havendo interesse estes poderão ser locados separadamente.
            </p>
            ...
            <p align="justify">2.4 Caso tenha a necessidade de climatizar o ambiente, antes do período estipulado da Cláusula primeira , será cobrado uma taxa no valor de R$ 300,00 ( Trezentos reais )..</p>
            <p align="justify">2.5 Será disponibilizado  23 mesas de 10 lugares ( sem as cadeiras), mais 2 (duas mesas madeira de 3 metros ), 02 mesas de madeira ( 2 metros ).</p>
            ...
            <p align="justify"><strong> 3.5.1 Toda montagem e desmontagem incluindo todo mobiliário e itens de decoração do evento , e objetos deixados no espaço , antes e depois do evento de responsabilidade do LOCATÁRIO ou de seus fornecedores. </strong> </p>
            ...
            <p align="justify"> 4.2 Para realização do evento é necessário que todas parcelas mencionadas na cláusula.</p>
            <p align="justify"> <strong>4.3 Caso a montagem e decoração do salão demande mais dias que o previsto neste contrato, o locatário deverá negociar as diárias de R$ 3.000,00 (três mil reias) necessárias. Devendo o LOCATÁRIO proceder à reserva no ato do contrato.</strong></p>
            <p align="justify"> <strong>4.4 O LOCATÁRIO pagará ao LOCADOR, até dois dias após o término do evento, os eventuais valores excedentes calculados conforme a Clausula Terceira, Clausula Quarta, bem como os valores relativos aos ressarcimentos de quaisquer danos eventualmente causados ao imóvel ou móveis e utensílios, conforme Clausula Terceira (item 3.4). </strong></p>
            ...
            <p align="justify"><strong>5.2 O LOCATÁRIO se compromete a desocupar o imóvel após o horário previsto na Cláusula Primeira (item 1.1), deixando-o em perfeito estado de conservação, conforme recebido no momento da locação. Deverá ser retirado todo mobiliário após o evento.</strong></p>
            <p align="justify"><strong>5.3. O LOCATÁRIO fica ciente que a energia elétrica é fornecida pela ENEL, com isso o LOCADOR fica isento de qualquer responsabilidade por falha no funcionamento da rede elétrica da ENEL. Sendo assim é de responsabilidade do LOCATARIO a locação do gerador elétrico. </strong> </p>
